...
// Example usage
int main() {
    std::cout << "Enhanced BCC-500 Emulator\n";
    std::cout << "=========================\n\n";
    
    BCC500System system;
    
    // Example: Terminal output program with "Hello World"
    std::vector<Word24> program = {
        // Print "Hello, BCC-500!" to terminal
        
        // Load 'H' and output
        (static_cast<Word24>(0x02) << 18) | 0x200,  // LOAD from 0x200
        (static_cast<Word24>(0x1A) << 18) | TERMINAL_DATA,  // OUTPUT
        
        // Load 'e' and output
        (static_cast<Word24>(0x02) << 18) | 0x201,
        (static_cast<Word24>(0x1A) << 18) | TERMINAL_DATA,
        
        // Load 'l' and output
        (static_cast<Word24>(0x02) << 18) | 0x202,
        (static_cast<Word24>(0x1A) << 18) | TERMINAL_DATA,
        ...
        // Load 'o' and output
        (static_cast<Word24>(0x02) << 18) | 0x203,
        (static_cast<Word24>(0x1A) << 18) | TERMINAL_DATA,
        
        // Load ',' and output
        (static_cast<Word24>(0x02) << 18) | 0x204,
        (static_cast<Word24>(0x1A) << 18) | TERMINAL_DATA,
        
        // Load ' ' and output
        (static_cast<Word24>(0x02) << 18) | 0x205,
        (static_cast<Word24>(0x1A) << 18) | TERMINAL_DATA,
        
        // Load 'B' and output
        (static_cast<Word24>(0x02) << 18) | 0x206,
        (static_cast<Word24>(0x1A) << 18) | TERMINAL_DATA,
        
        // Load 'C' and output
        (static_cast<Word24>(0x02) << 18) | 0x207,
        (static_cast<Word24>(0x1A) << 18) | TERMINAL_DATA,
        ...
        // Load '-' and output
        (static_cast<Word24>(0x02) << 18) | 0x208,
        (static_cast<Word24>(0x1A) << 18) | TERMINAL_DATA,
        
        // Load '5' and output
        (static_cast<Word24>(0x02) << 18) | 0x209,
        (static_cast<Word24>(0x1A) << 18) | TERMINAL_DATA,
        
        // Load '0' and output
        (static_cast<Word24>(0x02) << 18) | 0x20A,
        (static_cast<Word24>(0x1A) << 18) | TERMINAL_DATA,
        ...
        // Load '!' and output
        (static_cast<Word24>(0x02) << 18) | 0x20B,
        (static_cast<Word24>(0x1A) << 18) | TERMINAL_DATA,
        
        // Load newline and output
        (static_cast<Word24>(0x02) << 18) | 0x20C,
        (static_cast<Word24>(0x1A) << 18) | TERMINAL_DATA,
        
        // Halt
        (static_cast<Word24>(0x00) << 18) | 0x00
    };
    
    // Store character data
    system.getMemory().write(0x200, 'H');
    system.getMemory().write(0x201, 'e');
    system.getMemory().write(0x202, 'l');
    system.getMemory().write(0x203, 'o');
    system.getMemory().write(0x204, ',');
    system.getMemory().write(0x205, ' ');
    system.getMemory().write(0x206, 'B');
    system.getMemory().write(0x207, 'C');
    system.getMemory().write(0x208, '-');
    system.getMemory().write(0x209, '5');
    system.getMemory().write(0x20A, '0');
    system.getMemory().write(0x20B, '!');
    system.getMemory().write(0x20C, '\n');
    
    system.loadProgram(program, 0);
    
    std::cout << "Running terminal display example...\n\n";
    system.runProcessor(0, 200);
    ...
    std::cout << "Try: 'display' to see the terminal, 'load' to load programs\n";
    DebuggerInterface debugInterface(system);
    debugInterface.run();
